...
// Make sure to import buttonVariants from your actual button component file
      ...
      <div className="relative overflow-hidden bg-gradient-hero">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center">
          ...
          <div className="flex gap-4 justify-center">
            ...
            <Link 
              href="/auth" 
              className={cn(buttonVariants({ size: 'lg', variant: 'outline' }), "text-white border-white hover:bg-white/10")}
            >
              Sign In
            </Link>
          </div>
